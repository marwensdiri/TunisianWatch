 ...
 * @author Skan
 */
public class ResponsableForm1 extends javax.swing.JFrame {
    ...
    public ResponsableForm1(Object obj) {
        modif = true;
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        if (modif) {
            try {
                ...
                Logger.getLogger(ResponsableForm1.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
            try {
                int id;
